...
| B2.1 The five-theme taxonomy with paraphrased public examples; the review-level drill behind each theme bar (Metabase demonstration, 9g) | review_drill | `sql/marts/review_drill.sql` | `study/paraphrases.yaml`; https://apps.apple.com/; https://play.google.com/; https://www.opinion-assurances.fr/; https://www.trustpilot.com/ | Documented |
